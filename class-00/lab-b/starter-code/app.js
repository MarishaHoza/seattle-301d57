...
// no arrow functions as contructors, because arrow functions don't bind 'this'!
...
// DONE: After viewing the previous console.log(), return the code to a working state.
// again problems because of the scope of 'this'
...
//      arrow functions do not automatically bind "this" like normal functions
//      if "this" is used in an arrow function, it will bubble up to a parent
//      function (that isn't an arrow function) if nested, or to the browser
//      window itself.
