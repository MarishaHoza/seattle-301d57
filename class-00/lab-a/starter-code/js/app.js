...
function displayPics(){
  ...
  // declaring a variable using 'let' automatically scopes the variable to its applicable code block, so rando is not accesabble in the function scope, and is only accessable inside of the displayPics while statement.
  console.log(viewed);
